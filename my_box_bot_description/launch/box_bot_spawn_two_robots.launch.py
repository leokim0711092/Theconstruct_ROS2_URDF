...
def generate_launch_description():
   ...
   # Include the Gazebo launch file with the modified launch arguments
    ...
    xacro_file = os.path.join(robot_desc_path, 'urdf', 'bot_bot_final_two_spawn.xacro')

    robot_description_config_1 = xacro.process_file(xacro_file, mappings={"robot_name": robot_name_1}).toxml()
    param_1 = {'robot_description': robot_description_config_1}

    robot_description_config_2 = xacro.process_file(xacro_file, mappings={"robot_name": robot_name_2}).toxml()
    param_2 = {'robot_description': robot_description_config_2}
